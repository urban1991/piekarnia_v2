...
export const category = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'lead',
      title: 'Zajawka (karta na stronie głównej)',
      type: 'text',
      rows: 3,
      description: 'Krótki tekst na karcie kategorii na stronie głównej.',
    }),
    defineField({
      name: 'intro',
      title: 'Opis na stronie kategorii',
      type: 'text',
      rows: 3,
      description: 'Tekst pod tytułem na stronie kategorii (np. /chleby); trafia też do opisu strony w Google. Puste = użyta zostanie zajawka.',
    }),
